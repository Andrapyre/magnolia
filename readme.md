...
A binary is available on Maven Central as `com.softwaremill.magnolia1_2:magnolia_<scala-version>:1.1.9`. This may be added
to an [sbt](https://www.scala-sbt.org/) build with:

```
libraryDependencies += "com.softwaremill.magnolia1_2" %% "magnolia" % "1.1.9"
```
